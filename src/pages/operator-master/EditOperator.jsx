...
const AddOperator = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            const response = await axiosInstance.put(`operationMaster?uuid=${UId?.id}`, {
                name: data?.name,
    ...
    useEffect(() => {
        if (operatorData) {
            setValue("name", operatorData?.name);
            setValue("aadharCardNumber", operatorData?.adhar_card_number);
            setValue("mobileNumber", operatorData?.mobile_number);
            setValue("country", operatorData?.country);
            setValue("state", operatorData?.state);
            setValue("city", operatorData?.city);
            setValue("address", operatorData?.address);
            setValue("working_hours_without_lunch", operatorData?.working_hours_without_lunch);
            setValue("salary_per_day", operatorData?.salary_per_day);
        }
                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} md={6}>
                            ...
                            <Controller
                                ...
                                defaultValue=""
                                rules={{
                                    required: 'Working hrs is required',
