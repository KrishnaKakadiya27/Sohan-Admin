  ...
  return (
    <div className="bg-white p-4">
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-2xl font-semibold">Item Master List</h1>
      </div>
        ...
        <table className="w-full bg-white rounded-[8px] ">
          ...
          <tbody className="border">
            {isLoading && materialData?.length === 0 ?
              ...
              : (materialData?.length > 0 ? materialData?.map((item, index) => (
                <tr key={index}>
                  ...
                  <td className="py-2 min-w-[200px] border-[1px] border-[#D0D0D0]  px-4 border-b">
                    {item?.rawMaterialMasterDetail?.name}
                  </td>
                  <td className="py-2 min-w-[200px] border-[1px] border-[#D0D0D0]  px-4 border-b">
                    {item?.total_stock}
                  </td>
                  ...
                  <td className="py-2 border-[1px] border-[#D0D0D0]  px-4 border-b text-center">
                    ...
                    >
                      ...
                      <ActionButton
                        ...
                        label="View"
                        color="#3f3f3f"
                        onClick={() => navigate(`/item-master/view/${item?.uuid}`)}
                      />
                      ...
                      <ActionButton
                        ...
                        label="Edit"
                        color="#1976d2"
                        onClick={() => navigate(`/item-master/edit/${item?.uuid}`)}
                      />

                      {/* Delete Button */}
                      <DeleteMaterialMaster id={item?.uuid} getListData={getListData} />
                    </div>
                  </td>
                </tr>
              ))
